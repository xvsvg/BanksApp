...
{
    public class MakeWithdrawHandler : CommandHandler
    {
        ...
        public override void Handle(string command)
        {
            ...
            if (command.Contains("make withdraw"))
            {
                ...
                string total = SpectreConsoleWriter.WriteWithPrompt("Provide amount of money, you want to withdraw");
